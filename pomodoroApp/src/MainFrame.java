...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        breakTimeCB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                breakTimeCBActionPerformed(evt);
            }
        });
    ...
    private void addProjectBActionPerformed(java.awt.event.ActionEvent evt) {                                            
    ...
    private void projectsBActionPerformed(java.awt.event.ActionEvent evt) {                                          
        projectsFrame form2 = new projectsFrame();
    ...
    private void pomoTimeCBActionPerformed(java.awt.event.ActionEvent evt) {                                           
          
        if(Global.workflag){
                 String selectedTime = pomoTimeCB.getSelectedItem().toString();
         if(selectedTime != "5")
          ourClockLabel.setText(String.format(" %s:00 ", selectedTime));
         else  ourClockLabel.setText(String.format(" 0%s:00 ", selectedTime));
    ...
    private void itemsSelectCBActionPerformed(java.awt.event.ActionEvent evt) {                                              
        // TODO add your handling code here:
    }                                             
    ...
    private void stateCBActionPerformed(java.awt.event.ActionEvent evt) {                                        
        String selectedItem;
        if (stateCB.getSelectedItem() == "break") {
            selectedItem = breakTimeCB.getSelectedItem().toString();
            Global.workflag = false;
            workLabel.setText("break yeessss");
        } else {
            selectedItem = pomoTimeCB.getSelectedItem().toString();
        ...
        if(selectedItem == "5"){
              ourClockLabel.setText(String.format(" 0%s:00 ", selectedItem));
        }else {
                      ourClockLabel.setText(String.format(" %s:00 ", selectedItem));
    ...
    private void breakTimeCBActionPerformed(java.awt.event.ActionEvent evt) {                                            
  
             
        if(!Global.workflag){
                 String selectedTime = breakTimeCB.getSelectedItem().toString();
         if(selectedTime != "5")
          ourClockLabel.setText(String.format(" %s:00 ", selectedTime));
         else  ourClockLabel.setText(String.format(" 0%s:00 ", selectedTime));
